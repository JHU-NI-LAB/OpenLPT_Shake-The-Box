...
params = [angles camParaCalib.T' camParaCalib.k1];
camParaCalib.f_eff = 180;
params_const = [ camParaCalib.wpix, camParaCalib.hpix, camParaCalib.Npixw, camParaCalib.Npixh camParaCalib.f_eff];
...
%     camParaCalib_new.f_eff = params(7);
    camParaCalib_new.f_eff = 180;
    camParaCalib_new.k1 = params(7);
