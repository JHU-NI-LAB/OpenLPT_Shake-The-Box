...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    global img stop areanum centall lineall aa isx basepix baseidx gridspace origin_p2d3d
    global PathName
    if isempty(PathName)
        [FileName,PathName] = uigetfile('*.*','Select the picture from paper');
    else
        [FileName,PathName] = uigetfile([PathName '*.*'],'Select the picture from paper');
    end
    origin_p2d3d = [];
    img=imread([PathName,FileName]);
    axes(handles.axes1);
        i = input('Invert the color? 1 for yes, 0 for no')
    if i
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global finalnew PathName
[fname,pth] = uiputfile([PathName '/*.txt']); % Type in name of file.
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    global p2d3d holdon offseton gridspace PathName origin_p2d3d

    [FileName,PathName] = uigetfile([PathName '/*.*'],'4 cols or 5 cols');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global Npixh Npixw hpix wpix p2d3d origin_p2d3d camParaCalib camParaCalib1 bb offseton gridspace 
...
if ~isempty(origin_p2d3d)
    p2d3d = origin_p2d3d;  % recover back to the original before calibration
else
    origin_p2d3d = p2d3d;
end
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global camParaCalib PathName
[fname,pth] = uiputfile([PathName '/*.mat']); % Type in name of file.
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global isx xpos ypos xx lineall maxline minline centall finalnew isextra
