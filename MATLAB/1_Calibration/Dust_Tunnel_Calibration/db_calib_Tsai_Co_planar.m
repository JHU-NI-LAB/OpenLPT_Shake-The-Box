function [camParaCalib, varargout] = db_calib_Tsai_Co_planar(Ximg, Xp3D, camParaknown, imgsize, opt_offset)
...
%   opt_offset      --  find the offset of image center by nonliner
%                       optimization; disabled if opt_offset = 0;
%                       default = 0;
%
% outputs:
...
if( opt_offset == 0 )
    ...
    offset = fminsearch( @myfun, offset0,'MaxIter',1e7);
end

    function objval = myfun(v)
        camParaCalib.Noffw = v(1);
        camParaCalib.Noffh = v(2);
