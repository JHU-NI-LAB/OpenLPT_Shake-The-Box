...
isrotated=input('Is the target rotated? (Clockwise=1 Anti-clockwise=2 NoRotation=0)\n');
...
%     
    ...
    if isrotated
    x_dir=input('What is the direction of +ve x? enter 1 for down or 2 for up\n')
    else
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    global p2d3d holdon offseton gridspace
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global Npixh Npixw hpix wpix p2d3d camParaCalib camParaCalib1 bb offseton gridspace
